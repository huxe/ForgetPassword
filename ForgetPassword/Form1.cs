...
namespace ForgetPassword
{
    public partial class frmForgetPassword : Form
    {
      ...
      OleDbConnection con = new OleDbConnection(@"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=E:\c#\ForgetPassword\ForgetPassword\ForgetPassword.mdb");
        ...
        private void mail()
        {
            ...
            const string p = "24861478";


            MailMessage message = new MailMessage();
            SmtpClient smtp = new SmtpClient();

            message.From = new MailAddress("4getpassoop@gmail.com");

            //Enter your email blow and also change in database too

            message.To.Add(new MailAddress("your email"));
            ...
            smtp.Credentials = new NetworkCredential("4getpassoop@gmail.com", p);
